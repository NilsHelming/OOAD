...
public class NameviewAdapter extends BaseAdapter {
    ...
    public NameviewAdapter(Context context, List list){
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.nameview_adapter, null);
            holder.caption = (EditText) convertView.findViewById(R.id.content);
